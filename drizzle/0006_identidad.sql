...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "oauth_accounts_user_idx" ON "oauth_accounts" USING btree ("user_id");--> statement-breakpoint
/* Una cuenta, un dueño. La guarda permite reaplicar sin ruido. */
DO $$ BEGIN
